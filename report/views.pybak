...
def result_Soil_ohsr(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
	department = Department.objects.all().filter(id = 1)
	return render_to_response('report/soil_ohsr.html', {'ohsr':ohsr, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_chem(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/chemical_analysis.html', {'chem': chem, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_cube(request):
	...
	#{'cubee':cubee, 'Head':Head, 'organisation':organisation,'department':department,},
...
def result_cube(request):
	...
	ID = Id['Report_id__max']
	cubee = Cube.objects.filter(Report_id = ID)
	return render_to_response('report/cube.html', {'cubee':cubee, 'Head':Head,'organisation':organisation,'department':department,},context_instance=RequestContext(request))
'''
...
def result_water(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/water.html', {'water':water, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_brick(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/brick.html', {'brick':brick, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_soil_building(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/soil_building.html', {'Soil_building':Soil_building, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_Admixture(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/admixture.html', {'mixture': mixture, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_Cement_PPC(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/cement_ppc.html', {'ppc': ppc, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_Cement_OPC_33(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/cement_opc.html', {'opc33': opc33, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_Cement_OPC_43(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/cement_opc.html', {'opc43': opc43, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_Cement_OPC_53(request):
	...
	organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
	return render_to_response('report/cement_opc.html', {'opc53': opc53, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_steel(request):
        ...
        organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
        return render_to_response('report/steel.html', {'st': st, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_concretepaver(request):
        ...
        organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
        return render_to_response('report/concretepaver.html', {'cp': cp, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_tile(request):
        ...
        organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
        return render_to_response('report/tile.html', {'st': st, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
"""
PC
""" 
...
def result_pc(request):
        ...
        organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
        return render_to_response('report/pc.html', {'st': st, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_hammer(request):
        ...
        organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
        return render_to_response('report/hammer.html', {'st': st, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
...
def result_groundwater(request):
        ...
        organisation = Organisation.objects.all().filter(id = 1)
        department = Department.objects.all().filter(id = 1)
        return render_to_response('report/groundwater.html', {'st': st, 'Head':Head, 'organisation':organisation,'department':department,},context_instance=RequestContext(request))
